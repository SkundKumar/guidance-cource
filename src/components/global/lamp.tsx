  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-10 mb-20 bg-gradient-to-br from-neutral-300 to-neutral-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Why Should YOU
        <br /> Participate
      </motion.h1>
